#ifndef MYRIAD_CORE_MYRSINGLETON_H
#define MYRIAD_CORE_MYRSINGLETON_H

#include "core/core.h"

namespace Myriad
{
    template <class T> class MYR_API MyrSingleton
    {
      private:
        struct allow
        {
      ...
      public:
        // No cloning
        MyrSingleton(MyrSingleton const &other) = delete;
        // No assigning
        MyrSingleton &operator=(const MyrSingleton &) = delete;
        // void operator=(MyrSingleton const &) = delete;
