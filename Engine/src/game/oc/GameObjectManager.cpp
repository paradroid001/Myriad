...
{
    GameObjectManager::GameObjectManager(MYR_ID_t max_slots)
        : MyrObjectManager<GameObject, GOAlloc_t>()
    {
    ...
    void GameObjectManager::OnObjectCreate(MYR_ID_t id, void *ptr)
    {
        ...
        // If this line isn't here, no gameobjects get their ids set on
        // creation.
