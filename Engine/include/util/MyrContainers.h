#ifndef MYR_CONTAINERS_H
#define MYR_CONTAINERS_H

#include <cstdint>
#include <unordered_map>

#include "core/config.h" //MYR_ID_t, MYRIAD_INVALID_ID
...
namespace Myriad
{
    ...
    /**
     * @brief: An abstract class which holds objects by unique integer id
     * Integer ids start at 1, 0 is invalid.
     * @details: it expects void pointers.
     */
    class MyrIDSource
    {
      private:
