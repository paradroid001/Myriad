...
namespace Myriad::ObjectComponent
{
  ...
  class ComponentManager : public MyrObjectManager<ComponentBase, TypeAllocatorDynamic<ComponentBase>>
  {
  public:
    ...
    ComponentType *GetComponent(MYR_ID_t owner_id)
    {
      for (auto component : *this)
      {
        ...
        {
          ComponentType *p_typed_component = static_cast<ComponentType *>(component);
          if (p_typed_component->GetType() == ComponentType::Type()) // this needs to have resolved to a Component class
          {
